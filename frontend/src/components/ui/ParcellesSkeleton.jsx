...
export const ParcellesSkeleton = () => {
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-[#E0E0E0] dark:border-[#30363D]">
        <div>
          ...
          <div className="h-3 w-60 bg-[#E0E0E0] dark:bg-[#30363D] rounded mt-2" />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="bg-white dark:bg-[#161B22] p-5 rounded-2xl border border-[#E0E0E0] dark:border-[#30363D]">
            ...
            <div className="flex gap-3 pt-2 border-t border-[#E0E0E0] dark:border-[#30363D]">
              <div className="h-3 w-20 bg-[#E0E0E0] dark:bg-[#30363D] rounded" />
              <div className="h-3 w-20 bg-[#E0E0E0] dark:bg-[#30363D] rounded" />
            </div>
            <div className="flex gap-2 mt-3 pt-3 border-t border-[#E0E0E0] dark:border-[#30363D]">
